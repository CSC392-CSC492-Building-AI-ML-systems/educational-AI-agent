...
def load_system_prompt():
    try:
        ...
        print("⚠️ system_prompt.txt not found, using fallback")
    
    return "You are AutoDocs, an AI assistant specialized in creating comprehensive documentation."

SYSTEM_PROMPT = load_system_prompt()

def format_prompt_with_system(user_prompt):
...
def handler(job):
    ...
    try:
        # Add system prompt to user prompt
        formatted_prompt = format_prompt_with_system(prompt)
